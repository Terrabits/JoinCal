...
#include "../../../../../Core/CalibrationWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CalibrationWidget_t, stringdata) + ofs \
...
const QMetaObject CalibrationWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CalibrationWidget.data,
      qt_meta_data_CalibrationWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalibrationWidget.stringdata))
